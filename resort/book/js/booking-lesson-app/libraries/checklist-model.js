...
angular.module('checklist-model', [])
  .directive('checklistModel', ['$parse', '$compile', function ($parse, $compile) {
    ...
    function postLinkFn(scope, elem, attrs) {
      ...
      let getter = $parse(checklistModel);
      ...
      // value added to list
      let value = attrs.checklistValue ? $parse(attrs.checklistValue)(scope.$parent) : attrs.value;


      let comparator = angular.equals;
    ...
    return {
      ...
      compile: function (tElement, tAttrs) {
        ...
        if (!tAttrs.ngModel) {
          // local scope let storing individual checkbox model
